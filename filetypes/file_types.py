    ...
    def __init__(self, default_divisor='b'):
        ...
        self.add(
            [
                ...
                file_properties("m4v", 2 * MB),
                file_properties('iso', 100 * MB),
                file_properties('vhd', 1000 * MB),
                file_properties('vhdx', 1000 * MB),
                file_properties('zip', 1000 * MB),
                file_properties('tar', 1000 * MB),
                file_properties('gz', 1000 * MB),
                file_properties('gzip', 1000 * MB),
